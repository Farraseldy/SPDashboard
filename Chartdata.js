...
$(document).ready(function () {
    setInterval(fetchdata,10000); //Set Interval
}); 
...
var olddata =  [9, 10, 5, 2, 20, 25, 10];
     ...
     function updateChart_all(){
        ...
        if (progressNumber > 81)
            $('#progbar').toggleClass("progress-bar bg-info");
        else if (progressNumber <= 80 )
            $('#progbar').toggleClass("progress-bar bg-warning");
        else if (progressNumber <= 55)
            $('#progbar').toggleClass("progress-bar bg-danger");
     }
